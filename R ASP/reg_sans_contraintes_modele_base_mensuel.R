...
path = getwd()
mydata = read.xlsx("W://statapp/git/donnees_mensuelles.xlsx",1)  # read from first sheet
...
INdecomp<-decompose(INts) # l'objet INdecomp contient alors la décomposition de IN
